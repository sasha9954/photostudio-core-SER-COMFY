...
def _build_hard_continuity_contract_block(*, scene_contract: dict[str, Any] | None, opening_shot: bool) -> str:
    ...
    lines = [
        ...
        "- no younger/older drift and no fuller/thinner drift: preserve cheek/jaw fullness, neck/shoulder build, waist/hip/torso silhouette, and same overall body read across scenes",
        ...
        "- avoid repeating exact same corner/background composition in consecutive scenes unless storyboard explicitly requests hold",
        "- for lip_sync_music image-side base framing use priority: tight medium -> medium -> 3/4 body (lower boundary slightly below waist up to upper thigh); keep face/mouth/neck/shoulders/upper torso readable and include hands when possible; avoid extreme close-up and distant full-body defaults",
